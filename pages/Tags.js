        ...
        <h1 className="mb-10 text-white text-4xl font-black"><span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Tags</span> 🏷️</h1>
          ...
          <div className="flex flex-col">
              ...
              <div className="flex mb-4">
                {tagsSet.map(
                    (tag, index) => (
                      <button onClick = {() => setSearchTag(tag)} key = {index} className="text-white m-1 p-2 flex flex-col items-center justify-center border-solid border-2 border-[#9234ea] rounded-lg shadow-xl hover:shadow-[#9234ea] hover:shadow-sm hover:scale-105 transition-all duration-300 cursor-pointer bg-[#111111]">
