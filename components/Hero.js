...
function Hero() {
  return (
    <div className="flex justify-between items-center mx-4 mt-12">
        <div>
            <h1 className="text-white text-4xl font-black mb-1"><span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Magamed Taimeskhanov</span> 👋</h1>
